        ...
        <div className="w-full max-w-4xl">
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row">
            <div className="w-full md:w-1/2 p-8 md:p-12">
              ...
              <p className="text-sm text-gray-600 mb-6">Log in to continue recycling responsibly</p>
              ...
              <form onSubmit={handleSubmit} noValidate aria-label="Login form">
                ...
                <button
                  ...
                  disabled={loading}
                  aria-busy={loading}
                  className="w-full bg-eco-green-600 hover:bg-eco-green-700 active:bg-eco-green-800 text-white font-semibold py-3 rounded-lg shadow-md hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-eco-green-300 transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none disabled:hover:shadow-md"
                >
                  {loading ? (
            ...
            <aside className="hidden md:flex w-1/2 bg-gradient-to-br from-eco-green-50 to-eco-blue-50 items-center justify-center p-8" aria-label="Benefits of EcoRecycle">
              <div className="max-w-xs text-center">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  Schedule pickups, climb the leaderboard, and help prevent toxic waste from entering our environment.
                </p>
