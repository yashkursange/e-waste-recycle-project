...
const Dashboard = () => {
  ...
  const impactStats = [
    { label: "E-waste Recycled", value: "45.8", unit: "kg", icon: Package },
    { label: "CO₂ Saved", value: "128", unit: "kg", icon: Leaf },
    { label: "Rewards Earned", value: "850", unit: "pts", icon: Award }
  ];
  ...
  const recentActivity = [
    { text: "Pickup scheduled on 12 Jan", date: "2 days ago", icon: Calendar },
    { text: "Reward claimed", date: "5 days ago", icon: Gift },
    { text: "E-waste collected - 15kg", date: "1 week ago", icon: CheckCircle },
    { text: "Pickup completed successfully", date: "2 weeks ago", icon: Package }
  ];
            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-gray-800">{mockPickup.id}</p>
                </div>
              </div>
              <span 
            ...
            <div className="grid sm:grid-cols-3 gap-6 mb-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-800">{mockPickup.date}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-800">{mockPickup.timeSlot}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-800">{mockPickup.address}</p>
                </div>
              </div>
            </div>
