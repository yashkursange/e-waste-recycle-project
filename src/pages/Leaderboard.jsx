          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-gray-100/50">
                {loading ? (
                  <tr>
                    <td colSpan="4" className="px-6 py-12 text-center text-gray-500 font-medium h-48">
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right">
                        <div className="font-semibold text-slate-700 text-lg">
                          {((user?.items || 0) * 10).toLocaleString()} <span className="text-sm text-slate-400 font-normal">pts</span>
                        </div>
                      </td>
                    </tr>
                  ))
